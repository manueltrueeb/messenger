...
import 'package:messenger1/pages/auth/register_page.dart';
              ...
              children: <Widget> [
                const Text(
                  "Messenger",
                   ...
                   const Text("Login now to talk with your friends!", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                   Image.network("assets/assets/conversation.png"),
                   TextFormField(
